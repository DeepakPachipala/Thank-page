...
<stop offset="1" stop-color="#FF8B0E"/>
      ...
      <ellipse cx="49" cy="114" rx="50" ry="10" fill="#000000" opacity="0.1"/>
    </svg>
        ...
        <div>
            <h1 className='star-head'>Thank you for subscribing!</h1> 
            <p className='star-p'>You have successfully subscribed to our list.  We will <br></br> let you know when we launch. </p>
        </div> 
        <div className='btn-cont'>  
           <button className='cont-btn-2'>Update your preferences</button>

            <button className='cont-btn'>Back to flow-ui.com</button>
        </div> 
    ...
    <h2 className='flow'> <img className='img' src={f2} alt='flow-img'></img>flow ui</h2>
